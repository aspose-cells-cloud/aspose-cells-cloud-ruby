...
# Unit tests for AsposeCellsCloud::SvgSaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SvgSaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::SvgSaveOptions.new
  end
  ...
  describe 'test an instance of SvgSaveOptions' do
    it 'should create an instance of SvgSaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::SvgSaveOptions)
    end
  end
