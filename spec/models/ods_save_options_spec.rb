...
# Unit tests for AsposeCellsCloud::OdsSaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OdsSaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::OdsSaveOptions.new
  end
  ...
  describe 'test an instance of OdsSaveOptions' do
    it 'should create an instance of OdsSaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::OdsSaveOptions)
    end
  end
