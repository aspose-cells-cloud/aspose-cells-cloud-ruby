...
# Unit tests for AsposeCellsCloud::ValidationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidationResponse' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::ValidationResponse.new
  end
  ...
  describe 'test an instance of ValidationResponse' do
    it 'should create an instance of ValidationResponse' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::ValidationResponse)
    end
  end
