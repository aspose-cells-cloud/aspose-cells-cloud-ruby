...
# Unit tests for AsposeCellsCloud::XpsSaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XpsSaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::XpsSaveOptions.new
  end
  ...
  describe 'test an instance of XpsSaveOptions' do
    it 'should create an instance of XpsSaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::XpsSaveOptions)
    end
  end
