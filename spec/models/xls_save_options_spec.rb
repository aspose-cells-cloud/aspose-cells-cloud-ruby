...
# Unit tests for AsposeCellsCloud::XlsSaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XlsSaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::XlsSaveOptions.new
  end
  ...
  describe 'test an instance of XlsSaveOptions' do
    it 'should create an instance of XlsSaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::XlsSaveOptions)
    end
  end
