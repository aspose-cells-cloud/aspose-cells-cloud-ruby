...
# Unit tests for AsposeCellsCloud::SaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::SaveOptions.new
  end
  ...
  describe 'test an instance of SaveOptions' do
    it 'should create an instance of SaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::SaveOptions)
    end
  end
