...
# Unit tests for AsposeCellsCloud::XlsbSaveOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XlsbSaveOptions' do
  before do
    # run before each test
    @instance = AsposeCellsCloud::XlsbSaveOptions.new
  end
  ...
  describe 'test an instance of XlsbSaveOptions' do
    it 'should create an instance of XlsbSaveOptions' do
      expect(@instance).to be_instance_of(AsposeCellsCloud::XlsbSaveOptions)
    end
  end
