...
describe 'CellsPivotTablesApi' do
  ...
  describe 'cells_pivot_tables_put_worksheet_pivot_table test' do
    it "should work" do
      ...
      @instance.cells_pivot_tables_put_worksheet_pivot_table(name, sheet_name,  { :folder=>folder, :source_data=>source_data, :dest_cell_name=>dest_cell_name, :table_name=>table_name, :use_same_source=>use_same_source})
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
